package com.dome.springboot.curator.controller;


import com.dome.springboot.curator.service.DomeZooKeeperService;
...
public class DomeZooKeeperController {

    @Autowired
    private CuratorFramework zkClient ;
    @Autowired
    private DomeZooKeeperService service;
